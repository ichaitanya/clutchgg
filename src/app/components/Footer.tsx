  ...
  return (
    <footer className="arena-footer">
      <div className="arena-footer__inner">
        {/* Brand + tagline */}
        <div>
          <a href="/" className="arena-footer__brand" aria-label="Clutch.gg home">
        ...
        <div className="arena-footer__cols">
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.25rem' }}>
              <a href="https://instagram.com" className="arena-footer__link" style={{ marginBottom: 0 }} title="Instagram">
              ...
              <a href="https://twitter.com" className="arena-footer__link" style={{ marginBottom: 0 }} title="Twitter">
